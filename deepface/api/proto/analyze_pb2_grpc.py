...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in analyze_pb2_grpc.py depends on'
...
class AnalyzeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Analyze = channel.unary_unary(
                '/deepface.api.proto.AnalyzeService/Analyze',
...
def add_AnalyzeServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'deepface.api.proto.AnalyzeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('deepface.api.proto.AnalyzeService', rpc_method_handlers)
